...
import { SlidersHorizontal, Target, FlaskConical, BellRing, Users, Bot } from "lucide-react";
...
const PAGES = [
  ...
  { href: "/settings/ai-agent", label: "AI Reply Agent", desc: "Tone, guidelines, and the auto-reply kill switch", icon: Bot },
